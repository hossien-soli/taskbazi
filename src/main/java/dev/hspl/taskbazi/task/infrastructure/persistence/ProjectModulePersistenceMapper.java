package dev.hspl.taskbazi.task.infrastructure.persistence;
...
import dev.hspl.taskbazi.task.domain.value.CollaboratorRole;
import dev.hspl.taskbazi.task.domain.value.ProjectId;
import dev.hspl.taskbazi.task.domain.value.ProjectTitle;
import dev.hspl.taskbazi.task.infrastructure.persistence.entity.ProjectJPAEntity;
