...
import dev.hspl.taskbazi.user.domain.exception.UnacceptableRequestIdentificationDetailsException;
...
public record RequestIdentificationDetails(
        ...
        String agentIdentifier, // browser-identifier(name / version) or application-identifier(name / version) or cli-identifier
